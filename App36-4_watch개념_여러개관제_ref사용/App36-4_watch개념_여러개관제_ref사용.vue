...
export default {
  ...
  setup() {
    ...
    const currentPage = ref(1);       
                                                  // (1) currentPage와 numberOfTodos를 동시에 watch해 보겠다.      
    watch([currentPage, numberOfTodos], (currentPage, prev) => {  // (2) []로 감싸주고 numberOfTodos도 입력함.
      console.log(currentPage, prev)                              //     console에 현재페이지와 todos갯수가 찍힘
    });
